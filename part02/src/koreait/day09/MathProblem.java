...
public class MathProblem {
	...
	public void makeProb() { // 사칙연산 종류별로 적절한 난수 생성하기 -> 문제를 만들어 줍니다.
		...
		case '-':
			...
			break;
		case '*':
			max1=77;max2=29;min1=11;min2=11;	//n1은 11~77, n2는 11~29 : n1 > n2 곱셉 과정을 고려 n2를 작게
			break;
		case '/':
			max1=99;max2=29;min1=41;min2=11;	//n1은 41~99, n2는 11~29 : n1 > n2 나눗셈 과정을 고려 n1을 좀 더 크게
			break;
