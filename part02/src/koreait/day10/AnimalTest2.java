...
public class AnimalTest2 {
	...
	public static void main(String[] args) {
		Animal ani1 = new Frog();		//업(up)캐스팅 : 자동 변환 <-> 다운(down)캐스팅 : 강제 변환
		Animal ani2 = new Cat();
...
/*
 * Animal 부모 타입 참조는 자식 클래스 필드와 메소드 접근 못함.
		animal.jump();	//Frog
		animal.run();	//Dog
		animal.fly();	//Crow
		animal.sound();	//Cat
...
class Frog extends Animal {		//개구리
	protected int mouth;	//디폴트 한정자 + 다른 패키지 자식 클래스
	public Frog() {
	...
	//				ㄴ 부모 클래스의 메소드를 재정의. 이 때, 인자와 리턴 타입은 동일하게 합니다.
