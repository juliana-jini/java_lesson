...
public class DateTimeTest {
	...
	public static void main(String[] args) {
		//현재 시간 : ms, ns (1970년 1월 1일 자정을 기준으로 단위마다 카운트한 값입니다.)
	...
	*/
		...
		LocalDate mybirth = LocalDate.of(1999, 2, 11);
		System.out.println("내 탄신일 확인 : " + mybirth);
		
		LocalTime mybirth_time = LocalTime.of(13, 0);
		System.out.println("내 탄생 시간 : " + mybirth_time);
		
		//새 버전 클래스는 날짜 사이의 간격 계산 클래스가 있습니다. (ex. 내가 태어난지 몇년? 몇달? 몇일?)
