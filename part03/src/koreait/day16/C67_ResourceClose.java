...
//workspace UTF-8이면 텍스트 파일 UTF-8만
//			MS949이면 텍스트 파일 ANSI 형식만
public class C67_ResourceClose {

	public static void main(String[] args) {
		//파일 복사
//		String filename = "C:\\iclass05\\자바테스트.txt";	//읽기: 존재하는 파일
//		String filename2 = "C:\\iclass05\\자바테스트3.txt";	//쓰기: 존재하지 않는 파일
 ...
 * Implement 해서 사용 가능해야 함. Scanner, PrintWriter는 AutoClosable 구현 클래스
