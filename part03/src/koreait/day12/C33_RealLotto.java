...
//작성자 : 조윤진 - 파일 제출합니다. (주석으로 설명을 작성하세요. 너무 장황하지 않게 정리)
 ...
 */
		...
		for(int cnt=0;cnt<6;cnt++) {	//로또 번호 6개를 구하기 위한 for문
			...
			k=r.nextInt(45-cnt); 
			//cnt = 0, 1, 2, 3, 4, 5 에 대해 난수의 bound 값은 45, 44, 43, 42, 41, 40 -> 중복 방지(확률적인 범위를 줄이기)
			//k의 난수 범위? 0 ~ 44, 0 ~ 43, 0 ~ 42, 0 ~ 41, 0 ~ 40, 0 ~ 39
			
			System.out.println("k="+k +",number =" + numbers[k]);	//선택된 숫자의 인덱스 번호와 값 
