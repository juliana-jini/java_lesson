...
public class C70_StringSplit {
	...
	public static void main(String[] args) {
		...
		//split의 인자인 문자열은 정규식(regex) 문자열입니다.(정규식 패턴은 복잡. 어렵습니다.)
		//		정규식 예시 : [] 안에 표시하는 것은 문자 여러 개가 또는(or)에 해당합니다.
		temp2 = "모모,90 88()79";
		...
		//Arrays.asList는 테스트용으로 또는 간단한 고정 리스트 사용으로 만들 때 유용합니다.
