...
//	(참고: main 메소드를 갖는 클래스를 객체로 만들지 않는 것이 일반적입니다.)
	public static void main(String[] args) {
		...
		//test1, test2는 참조형 변수
		C35_GlobalVar test1 = new C35_GlobalVar();		//C35의 클래스 타입의 객체를 생성
		C35_GlobalVar test2 = new C35_GlobalVar();		//C35의 클래스 타입의 객체를 생성
		
		//C35 클래스에서 static이 아닌 인스턴스 변수에는 객체마다 다른 값을 저장합니다. - 객체 각각 다른 특성을 나타냅니다.
		test1.count = 10;
		test2.count = 20;
...
//		C35_GlobalVar.TEST = 100;		//오류 : final은 값 변경 못합니다.
		...
		System.out.println("C35_GlobalVar.num = " + C35_GlobalVar.point);		//0.0
