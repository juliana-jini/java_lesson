...
public class C27_IntArray {
	...
	public static void main(String[] args) {
		...
		int[] arr2 = new int[7];				//배열의 크기만 설정. 기본 초기값 있나요? 답: 0
		...
		//출력 예시 : arr1[0] = 67 형식으로 모든 값을 출력하고 싶다. -> for문
		System.out.println("\nfor문으로 배열 요소값 출력(arr1)");
		for(int i=0;i<7;i++)
			System.out.println("arr1["+i+"] = "+ arr1[i]);
		
		System.out.println("\nfor문으로 배열 요소값 출력(arr2)");
		for(int i=0;i<arr2.length;i++)	{	//***배열은 배열 요소의 갯수(크기)를 갖고 있는 필드 length가 있습니다.
