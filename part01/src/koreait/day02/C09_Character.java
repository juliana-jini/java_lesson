...
//		System.out.printf("c1= %d\n",c1);	//¿À·ù: charÇüÀº %d°¡ ¾Æ´Õ´Ï´Ù.
		...
		c1 = (char)(c1 + 1);	//µ¡¼À ¿¬»ê ±â´É. ¿¬»ê °á°ú ´ëÀÔÇÒ ¶§´Â casting ÇÊ¿ä.
		System.out.println("c1 = " + c1);
		
		c1++;					//++ ¿¬»êÀº c1 = c1 + 1, charÇü¿¡¼­´Â castingÀÌ ÇÊ¿ä¾ø½À´Ï´Ù.(int ¸®ÅÍ·² »ç¿ëÇÑ °è»êÀÌ ¾Æ´Õ´Ï´Ù.)
		System.out.println("c1 = " + c1);
	...
	//charÀÌ ¸ð¿©¼­ ÇÑ ÁÙ·Î ³ª¶õÈ÷ ³ª¿­ÇÏ¸é -> ¹®ÀÚ¿­ÀÌ µË´Ï´Ù. "Hello"´Â 'H', 'e', 'l', 'l', 'o'

}
/*
 *	±âº»Çü½Ä µ¥ÀÌÅÍ : ¹®ÀÚÇü char 
 *		¹®ÀÚµ¥ÀÌÅÍ¸¦ ÀúÀåÇÏ´Â 2¹ÙÀÌÆ® Çü½Ä. Á¤¼ö°ªÀ» 0 ~ 65535 ¹üÀ§ ÀúÀåµµ °¡´ÉÇÕ´Ï´Ù.
