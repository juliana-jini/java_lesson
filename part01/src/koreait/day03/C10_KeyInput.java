...
//키보드 입력을 위한 변수 선언. - 표준입력으로 Scanner 객체를 만들고 변수 sc가 참조합니다.
		...
		data = sc.nextInt();		//사용자로부터 키보드로 입력받고 그 값을 정수로 변환하여 data 변수에 저장.
 ...
 * 						-> 기본 패키지의 클래스가 아니므로 import가 필요합니다.
 * 					*참고 : 기본 패키지 java.lang은 import 없이 사용합니다.
 * 
 * 참고 : 자동완성 단축키는 ctrl + spacebar
 * 콘솔창 띄우는 법 : Window > Show View > Console
 * 
 */