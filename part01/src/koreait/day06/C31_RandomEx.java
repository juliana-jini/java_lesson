...
public class C31_RandomEx {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * 90~100 	: o명 ( 소수점 1자리 %)	카운트 변수가 5개 필요합니다. (cntA, cntB, cntC, cntD, cntF)
		 * 80~89  	: o명 ( 소수점 1자리 %)			     ㄴ counts[5] : counts[0], counts[1] 
		 * 70~79  	: o명 ( 소수점 1자리 %) counts[2]
		 * 60~69  	: o명 ( 소수점 1자리 %) counts[3]
		 * 60점 미만 	: o명 ( 소수점 1자리 %) counts[4]
		 * 
		 */
